...
describe(' serviceAccount', () => {
  describe('selectors', () => {
    ...
    describe(getEditorPhaseById.name, () => {
    ...
    describe(getEditorPhaseRepetitionsById.name, () => {
    ...
    describe(getEditorPhaseStepsById.name, () => {
